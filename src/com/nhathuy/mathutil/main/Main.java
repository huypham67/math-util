...
public class Main {
    public static void main(String[] args) {
        ...
        //ví dụ: -5 coi tính đc hong
        //        0 coi tính mấy
        //       20 coi tính mấy
        //       21 coi tính ra mấy!!!
        //TEST CASE: Một tình huống hàm/app/màn hình/tính năng đc đua vào sử dụng
        //giả lập hành vi xài của ai đó!!!
        
        //TEST CASE: LÀ TÌNH HUỐNG SỬ DỤNG, XÀI APP (HÀM) MÀ NÓ BAO HÀM
